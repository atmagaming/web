...
<section bind:this={el} class="py-32 px-6 relative overflow-hidden">
  <div
    class="absolute inset-0 bg-[radial-gradient(ellipse_at_center,_var(--color-accent-600)_0%,_transparent_70%)] opacity-10"
  ></div>

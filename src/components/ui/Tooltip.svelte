...
<span class="tooltip-trigger relative">
  ...
  <span class="tooltip-box absolute left-1/2 -translate-x-1/2 top-full opacity-0 pointer-events-none transition-opacity duration-150 z-10 p-6 -m-3">
    <span class="block w-64 bg-dark-950 text-white text-[0.82rem] leading-normal p-4">
      {description}
      {#if href}
        <a
          {href}
          ...
          class="block mt-2 font-mono text-[0.6rem] tracking-widest uppercase text-gold hover:text-white transition-colors no-underline"
